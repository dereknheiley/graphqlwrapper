...
public class ContinentQueryServiceTest {
	...
	@Test
	void parseContinents() throws JsonProcessingException {
		Response parsed = ContinentQueryService.parseContinents(allGraphqlResults);
	...
	// TODO move to a better place for a big blob of data
